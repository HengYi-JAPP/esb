...
public class DbvD {
    ...
    public static void main(String args[]) throws GeneralSecurityException {
        ...
        System.out.println(decrypt("GGEcGJkFGro=", "qinda"));
    }
    ...
    private static Cipher getCipher(String paramString, int paramInt)
        ...
        PBEParameterSpec localPBEParameterSpec = new PBEParameterSpec(arrayOfByte, 10);
    ...
    public static String encrypt(String paramString1, String paramString2,
        ...
        try {
            ...
            byte[] arrayOfByte2 = Base64.getEncoder().encode(localCipher.doFinal(arrayOfByte1));
